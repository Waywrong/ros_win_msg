...
namespace pr2_mechanism_controllers
{
  ...
  class BaseOdometryState : public ros::Msg
  {
    public:
      ...
      double st_drive_constraint_errors;
      double * drive_constraint_errors;
      uint8_t longitudinal_slip_constraint_errors_length;
      double st_longitudinal_slip_constraint_errors;
      double * longitudinal_slip_constraint_errors;
