#ifndef _ROS_mvsim_NodeExampleData_h
#define _ROS_mvsim_NodeExampleData_h
...
namespace mvsim
{
  ...
  class NodeExampleData : public ros::Msg
  {
    public:
      const char* message;
      int32_t a;
    ...
    const char * getType(){ return "mvsim/NodeExampleData"; };
    const char * getMD5(){ return "3192b76bfe6df73dcca63fc0aa4efaf9"; };
